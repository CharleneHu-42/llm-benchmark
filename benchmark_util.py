...
class BenchmarkWrapper:
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        last_token_time = []
        import datetime
        print("Generation started at", datetime.datetime.now().time())
        while True:
            ...
            if first_token_time is None:
                ...
                print("1st token generated at:", datetime.datetime.now().time())
                print("1st token generation time:", end-st)
            else:
        ...
        if len(last_token_time) > 1:
            ...
            self.rest_cost_p90 = np.percentile(last_token_time, 90)
            if self.do_print:
